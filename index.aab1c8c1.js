function e(e,t,s,o){Object.defineProperty(e,t,{get:s,set:o,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},s={},o={},i=t.parcelRequire93c5;function a(e){let t=document.createElement("div"),s=document.createElement("style"),o=i("74hXr"),a=i("jgk0D"),r=i("dwqVN");t.innerHTML=`
  ...
  `;let n=t.querySelector(".btn");return n.addEventListener("click",()=>{let t=location.pathname;"/instructions"==t&&e.goTo("/jugada")}),t.appendChild(s),t}function r(e){let t=document.createElement("div"),s=document.createElement("style"),o=i("74hXr"),a=i("jgk0D"),r=i("dwqVN");t.innerHTML=`
    <div class= "welcome">
  ...
  `,s.textContent=`
        ...
        `;let l=t.querySelector("#rock"),d=t.querySelector("#paper"),p=t.querySelector("#scissors");l.addEventListener("click",()=>{l.classList.replace("desactive","active"),d.classList.replace("active","desactive"),p.classList.replace("active","desactive")}),d.addEventListener("click",()=>{d.classList.replace("desactive","active"),l.classList.replace("active","desactive"),p.classList.replace("active","desactive")}),p.addEventListener("click",()=>{p.classList.replace("desactive","active"),l.classList.replace("active","desactive"),d.classList.replace("active","desactive")});let u=setInterval(()=>{!0===l.classList.contains("active")&&n.setMove("piedra"),!0===d.classList.contains("active")&&n.setMove("papel"),!0===p.classList.contains("active")&&n.setMove("tijera"),clearInterval(u)},4e3),m=setInterval(()=>{let e=n.getState(),s=t.querySelector("#rockComputer"),o=t.querySelector("#paperComputer"),i=t.querySelector("#scissorsComputer");"piedra"==e.currentGame.computerPlay?s.classList.add("active"):s.classList.add("desactive"),"papel"==e.currentGame.computerPlay?o.classList.add("active"):o.classList.add("desactive"),"tijera"==e.currentGame.computerPlay?i.classList.add("active"):i.classList.add("desactive"),clearInterval(m)},4050),h=setInterval(()=>{console.log("Redireccionando a la pantalla score");let t=location.pathname;"/jugada"==t&&e.goTo("/results"),clearInterval(h)},5550);return t.appendChild(s),t}function l(e){console.log("Soy la pagina results");let t=document.createElement("div"),s=document.createElement("style"),o=document.querySelector(".contenedor"),a=i("iY6hz"),r=i("4sGPP");var c=0,l=0;let d=n.getState(),p=d.history;for(let e of p){var u=n.whoWins(e.myPlay,e.computerPlay);console.log(u,"soy el win"),u&&(console.log("GANASTE"),c++,o.classList.add("colorWin"),o.classList.replace("colorLoose","colorWin"),t.innerHTML=`
    ...
    `;let m=t.querySelector(".boton-volver"),h=t.querySelector(".boton-reset"),g=t.querySelector(".poster-restart-score"),v=t.querySelector(".quit"),f=t.querySelector(".general");return m.addEventListener("click",()=>{let t=location.pathname;"/results"==t&&e.goTo("/jugada")}),h.addEventListener("click",()=>{n.restartScore(),g.classList.replace("off","on"),g.classList.contains("on")&&f.classList.add("opacityDiv")}),v.addEventListener("click",()=>{g.classList.replace("on","off"),f.classList.contains("opacityDiv")&&f.classList.replace("opacityDiv","f")}),t.appendChild(s),t}const d=[{path:/\/instructions/,handler:a},{path:/\/desafio-mod5\/instructions/,handler:a},{path:/\/welcome/,handler:r},{path:/\/desafio-mod5\/welcome/,handler:r},{path:/\/jugada/,handler:c},{path:/\/desafio-mod5\/jugada/,handler:c},{path:/\/results/,handler:l},{path:/\/desafio-mod5\/results/,handler:l}];customElements.define("button-comp",class extends HTMLElement{shadow=this.attachShadow({mode:"open"});constructor(){super(),this.render()}render(){let e=document.createElement("div"),t=document.createElement("style");t.innerHTML=`
      ...
      `,this.shadow.appendChild(e)}}),customElements.define("count-down",class extends HTMLElement{shadow=this.attachShadow({mode:"open"});constructor(){super(),this.render()}render(){let e=document.createElement("div"),t=document.createElement("style"),s=3;var o=setInterval(()=>{console.log("Soy el time",s),e.innerHTML=`
            ...
            `,this.shadow.appendChild(e),this.shadow.appendChild(t)}}),function(){let e=document.querySelector(".contenedor");!function(e){function t(e){history.pushState({},"",e),s(e)}function s(s){for(let o of d)if(o.path.test(s)){let s=o.handler({goTo:t});e.firstChild&&e.firstChild.remove(),e.appendChild(s)}}"/desafio-mod5/"==location.pathname&&t("/desafio-mod5/welcome"),"/"==location.pathname&&t("/welcome"),s(location.pathname)}(e)}();
//# sourceMappingURL=index.aab1c8c1.js.map
